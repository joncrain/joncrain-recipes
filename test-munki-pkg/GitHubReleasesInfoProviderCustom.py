...
"""See docstring for GitHubReleasesInfoProviderCustom class"""
...
__all__ = ["GitHubReleasesInfoProviderCustom"]


class GitHubReleasesInfoProviderCustom(Processor):
    description = (
...
if __name__ == "__main__":
    PROCESSOR = GitHubReleasesInfoProviderCustom()
